...
VALUES 
((SELECT id FROM organization WHERE name = 'A FAKE ORGANIZATION'), (SELECT id FROM university WHERE name = 'A FAKE UNIVERSITY'), 'Fake project 1', 'This is a complicated project involving deep learning, NoSQL, and other buzzwords that will certainly attract developers who call themselves "ninjas."'), 
((SELECT id FROM ORGANIZATION WHERE name = 'A FAKE ORGANIZATION'), 'Fake project 2', 'This is a regular project involving, NoSQL, and technologies that will probably just work properly.');
